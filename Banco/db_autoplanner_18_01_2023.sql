...
-- Copiando dados para a tabela auto_planner.tb_aluno: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela auto_planner.tb_endereco: ~15 rows (aproximadamente)
...
-- Copiando dados para a tabela auto_planner.tb_professor: ~13 rows (aproximadamente)
...
-- Copiando estrutura para tabela auto_planner.tb_teste
...
-- Copiando dados para a tabela auto_planner.tb_teste: ~12 rows (aproximadamente)
INSERT INTO `tb_teste` (`id`, `id_aluno`, `dia_semana`, `hora_inici`, `hora_fim`) VALUES
